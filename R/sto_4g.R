#' Function to generate STO-4G type orbital functions
#'
...
#' @examples
#' TRUE
sto_4g_generator <- function(element) {

  basis_data <- load_basis_set("sto-4g", element)

  sto_4g_function  <- function(radius) {
    ...
    gto_funs <- list(gto_a, gto_b, gto_c, gto_d)
    output <- gto_funs |>
